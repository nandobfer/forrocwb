...
import { Box, IconButton, LinearProgress, Paper, useMediaQuery } from "@mui/material"
...
export const EventLocation: React.FC<EventLocationProps> = (props) => {
    ...
    return (
        <Paper elevation={2} sx={{flexDirection: 'column', position: 'relative'}}>
            <iframe
                src={mapUrl}
                style={{ border: 0, width: "100%", borderRadius: 5, height: 400 }}
                loading="lazy"
                allowFullScreen
            ...
            <IconButton sx={{position: 'absolute', right: 5, top: 5, bgcolor: 'primary.main'}} color="default" size='small'>
